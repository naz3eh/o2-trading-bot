...
export default function TradingAccount({ account, isEligible }: TradingAccountProps) {
  ...
  return (
    <div className="trading-account">
      <div className="account-header">
        <div>
          ...
          <div className="account-ids">
            <div className="account-id-item">
              <span className="account-id-label">o2 Account Id:</span>
              <span 
            ...
            <div className="account-id-item">
              <span className="account-id-label">Wallet Connected:</span>
              <span 
                className="account-id-text clickable"
        ...
        {isEligible !== null && (
          <div className={`whitelist-badge ${isEligible ? 'whitelisted' : 'not-whitelisted'}`}>
