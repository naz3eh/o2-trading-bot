...
export enum FeeErrorInput {
  NoFeesAvailable = 'NoFeesAvailable',
}
export enum FeeErrorOutput {
  NoFeesAvailable = 'NoFeesAvailable',
}
...
export enum OrderBookInitializationErrorInput {
...
export enum OrderBookInitializationErrorOutput {
  InvalidAsset = 'InvalidAsset',
  InvalidDecimals = 'InvalidDecimals',
  InvalidPriceWindow = 'InvalidPriceWindow',
  InvalidPricePrecision = 'InvalidPricePrecision',
...
export enum SideInput {
  Buy = 'Buy',
  Sell = 'Sell',
}
export enum SideOutput {
  Buy = 'Buy',
  Sell = 'Sell',
}
...
export type FeesClaimedEventInput = { base_fees: BigNumberish; quote_fees: BigNumberish };
export type FeesClaimedEventOutput = { base_fees: BN; quote_fees: BN };
export type MatchIdInput = { maker_id: string; taker_id: string };
...
export type OrderArgsInput = { price: BigNumberish; quantity: BigNumberish; order_type: OrderTypeInput };
export type OrderArgsOutput = { price: BN; quantity: BN; order_type: OrderTypeOutput };
export type OrderBookBlacklistEventInput = { blacklist: Option<ContractIdInput> };
export type OrderBookBlacklistEventOutput = { blacklist: Option<ContractIdOutput> };
...
export type OrderBookSymbolsEventInput = { base_symbol: StdString; quote_symbol: StdString };
export type OrderBookSymbolsEventOutput = OrderBookSymbolsEventInput;
export type OrderBookWhitelistEventInput = { whitelist: Option<ContractIdInput> };
export type OrderBookWhitelistEventOutput = { whitelist: Option<ContractIdOutput> };
export type OrderCancelledEventInput = { order_id: string; timestamp: TimeInput };
export type OrderCancelledEventOutput = { order_id: string; timestamp: TimeOutput };
export type OrderCancelledInternalEventInput = { order_id: string; timestamp: TimeInput };
export type OrderCancelledInternalEventOutput = { order_id: string; timestamp: TimeOutput };
...
export type OrderMatchedEventOutput = { match_id: MatchIdOutput; quantity: BN; price: BN; timestamp: TimeOutput };
export type OrderOutOfGasEventInput = { order_id: string; timestamp: TimeInput };
export type OrderOutOfGasEventOutput = { order_id: string; timestamp: TimeOutput };
export type OrderTooSmallEventInput = { order_id: string; timestamp: TimeInput };
export type OrderTooSmallEventOutput = { order_id: string; timestamp: TimeOutput };
...
export type WithdrawSettledTradeEventOutput = { trader_id: IdentityOutput; base_amount: BN; quote_amount: BN };
